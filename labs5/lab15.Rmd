...
xml_find_all(linkList, "/document/linkList[@name='A']/document")
```
...
xml_find_all(jobs, "/jobs/job[@priority='critical' or @priority='high']/@name")
```
